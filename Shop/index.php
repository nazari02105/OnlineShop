...
<body>
    ...
    <div id="slides-shop" class="cover-slides">
        <ul class="slides-container">
            <li class="text-left">
                <img src="images/Teachers/MrFarahani.jpg" alt="" width="100%" height="100%">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> Thewayshop</strong></h1>
                            <p class="m-b-40">Mr Farahani</p>
                        </div>
                    </div>
                </div>
            </li>
            <li class="text-center">
                <img src="images/Teachers/MrRadfar.jpg" alt="" width="100%" height="100%">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> Thewayshop</strong></h1>
                            <p class="m-b-40">Mr Radfar</p>
                        </div>
                    </div>
                </div>
            </li>
            <li class="text-right">
                <img src="images/Teachers/MrSobhani.jpg" alt="" width="100%" height="100%">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> Thewayshop</strong></h1>
                            <p class="m-b-40">Mr Sobhani</p>
                        </div>
                    </div>
                </div>
            </li>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="images/firstPageCategory/t-shirts-img.jpg" alt="" />
                        <a class="btn hvr-hover" href="shop.php">T-shirts</a>
                    </div>
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="images/firstPageCategory/shirt-img.jpg" alt="" />
                        <a class="btn hvr-hover" href="shop.php">Shirt</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="images/firstPageCategory/wallet-img.jpg" alt="" />
                        <a class="btn hvr-hover" href="shop.php">Wallet</a>
                    </div>
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="images/firstPageCategory/women-bag-img.jpg" alt="" />
                        <a class="btn hvr-hover" href="shop.php">Bags</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="images/firstPageCategory/shoes-img.jpg" alt="" />
                        <a class="btn hvr-hover" href="shop.php">Shoes</a>
                    </div>
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="images/firstPageCategory/jacket.jpg" alt="" />
                        <a class="btn hvr-hover" href="shop.php">jacket</a>
                    </div>
                </div>
            </div>
        </div>
