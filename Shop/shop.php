                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    <img src=<?php echo $product_arr[$i]; ?> class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                        ...
                                                        <a class="cart" onclick="forBuy('<?php echo $product_arr[$i]; ?>', '<?php echo $_COOKIE['theUsername']; ?>')">Add to Cart</a>
                                                    </div>
                                                </div>
                                                <div class="why-text">
                                                    <h4>Lorem ipsum dolor sit amet</h4>
                                                    <h5><?php echo $price_arr[$i]; ?></h5>
                                                </div>
                                            </div>
                                        </div>
                                        <?php
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    ...
                                                    <a class="btn hvr-hover" onclick="forBuy('<?php echo $product_arr[$i]; ?>', '<?php echo $_COOKIE['theUsername']; ?>')">Add to Cart</a>
                                                </div>
                                            </div>
                                        </div>
                                        </div>
